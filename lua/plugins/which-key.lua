...
config = function() -- This is the function that runs, AFTER loading
  ...
  require('which-key').register {
    ...
    ['<leader>g'] = { name = 'Go to definition with gd and gr and comment', _ = 'which_key_ignore' },
    ...
    ['<leader>gcc'] = { name = 'Comment Toggle', _ = 'which_key_ignore' },
    ['<leader>gc'] = { name = 'Comment Toggle', _ = 'which_key_ignore' },
